namespace Nett
{
    ...
    public sealed partial class TomlSettings
    {
        ...
        public interface IPropertyMappingBuilder
        {
            ...
            /// </param>
            /// <returns>Fluent configuration builder continuation object.</returns>
            IPropertyMappingBuilder WhenTargetPropertyMissing(Action<string[], object, TomlObject> whenNotFound);
        }
        ...
        internal sealed class PropertyMappingBuilder : IPropertyMappingBuilder
        {
            ...
            public IPropertyMappingBuilder WhenTargetPropertyMissing(Action<string[], object, TomlObject> whenNotFound)
            {
